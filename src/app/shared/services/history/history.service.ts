...
} from "@shared/services/history/history";
...
export class HistoryService {
  ...
  geProfitHistory(
    ...
    return this._httpClient
      .get<ProfitHistoryPagination>(`${environment.apiUrl}/history/profit`, {
        params: {
          page,
          size,
          startAt,
  ...
  getOrderHistory(
    ...
    return this._httpClient
      .get<OrderHistoryPagination>(`${environment.apiUrl}/history/order`, {
        params: {
          page,
          size,
          startAt,
